...
def main(page: ft.Page):
    ...
    def start_app():
        ...
        header = ft.Container(
            content=ft.Row(
                [
                    ft.Text("Deal Exchange 🤝", size=22, weight="bold", color="green"),
                ...
                if res.status_code == 200 and res.json():
                    for k, v in res.json().items():
                        post_list.controls.append(
                            ft.Container(
                                content=ft.Column([
                                    ft.Text(v.get("user", ""), weight="bold", color="green"),
                                    ft.Text(v.get("offer", ""), color="white"),
                                ]),
                                padding=10,
                                margin=5,
                                bgcolor="#1e1e1e",
        ...
        page.add(
            ...
            post_btn,
            refresh_btn,
            ft.Text("Recent Deals", size=18, weight="bold", color="green"),
            post_list
        )
    ...
    splash = ft.Column(
        [
            ...
            ft.Text("Deal Exchange Pro", size=28, weight="bold", color="blue"),
            ft.Text("Developed by Rizwan Ali", size=14, color="gold"),
            ft.ProgressRing(color="green")
        ],
